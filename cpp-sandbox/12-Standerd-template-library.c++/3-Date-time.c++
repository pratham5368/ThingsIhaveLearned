/*In C++, you can work with dates and times using the chrono library, which is part of the Standard Library (STL). 
The chrono library provides various data types and functions to represent and manipulate time durations, time points, and clocks.*/

//1. duration represents a span of time, which can be expressed in various units such as seconds, minutes, hours, etc. 
//To create a duration, use the std::chrono::duration template class. Common predefined duration types are:
...
//2.time_point represents a specific point in time. It is usually created using a combination of duration and a clock.
// In C++, there are three clock types provided by the chrono library:
